...
// Generate unique ticket number (private helper)
...
exports.SupportTicketService = {
    ...
    createSupportTicket: (userId, userRole, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    getMyTickets: (userId, query) => __awaiter(void 0, void 0, void 0, function* () {
        const ticketQuery = new QueryBuilder_1.default(supportTicket_model_1.SupportTicket.find({ user: userId }), query)
            .filter()
            .sort()
            .paginate()
            .fields();
    ...
    getMyTicketById: (ticketId, userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    getAllTickets: (query) => __awaiter(void 0, void 0, void 0, function* () {
        const ticketQuery = new QueryBuilder_1.default(supportTicket_model_1.SupportTicket.find().populate('user', 'name email profilePicture'), query)
    ...
    getTicketById: (ticketId) => __awaiter(void 0, void 0, void 0, function* () {
        const ticket = yield supportTicket_model_1.SupportTicket.findById(ticketId).populate('user', 'name email profilePicture phone');
        if (!ticket) {
            throw new ApiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, 'Ticket not found');
        }
        return ticket;
    ...
    updateTicketStatus: (ticketId, status, adminNotes) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    updateTicketPriority: (ticketId, priority) => __awaiter(void 0, void 0, void 0, function* () {
        const ticket = yield supportTicket_model_1.SupportTicket.findById(ticketId);
        if (!ticket) {
            throw new ApiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, 'Ticket not found');
        }
        const result = yield supportTicket_model_1.SupportTicket.findByIdAndUpdate(ticketId, { priority }, { new: true, runValidators: true }).populate('user', 'name email');
        return result;
    }),
    // Add admin notes (admin only)
    addAdminNotes: (ticketId, adminNotes) => __awaiter(void 0, void 0, void 0, function* () {
        const ticket = yield supportTicket_model_1.SupportTicket.findById(ticketId);
        if (!ticket) {
            throw new ApiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, 'Ticket not found');
        }
        const result = yield supportTicket_model_1.SupportTicket.findByIdAndUpdate(ticketId, { adminNotes }, { new: true, runValidators: true }).populate('user', 'name email');
        return result;
    }),
    // Get ticket statistics (admin dashboard)
    getTicketStats: () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const open = yield supportTicket_model_1.SupportTicket.countDocuments({
            status: supportTicket_interface_1.TICKET_STATUS.OPEN,
        });
