...
exports.SupportTicketController = {
    createSupportTicket: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    getMyTickets: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const userId = req.user.id;
    ...
    getMyTicketById: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    getTicketCategories: (0, catchAsync_1.default)((_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    getAllTickets: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    getTicketById: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const { ticketId } = req.params;
    ...
    updateTicketStatus: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const { ticketId } = req.params;
    ...
    updateTicketPriority: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const { ticketId } = req.params;
    ...
    // Add admin notes
    addAdminNotes: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const { ticketId } = req.params;
    ...
    getTicketStats: (0, catchAsync_1.default)((_req, res) => __awaiter(void 0, void 0, void 0, function* () {
