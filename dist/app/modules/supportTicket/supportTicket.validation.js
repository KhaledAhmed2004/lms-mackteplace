...
exports.SupportTicketValidation = {
    createSupportTicketZodSchema: zod_1.z.object({
        body: zod_1.z.object({
    ...
    updateTicketStatusZodSchema: zod_1.z.object({
        body: zod_1.z.object({
    ...
    updateTicketPriorityZodSchema: zod_1.z.object({
        body: zod_1.z.object({
    ...
    addAdminNoteZodSchema: zod_1.z.object({
        body: zod_1.z.object({
            adminNotes: zod_1.z
                .string({
