...
exports.AdminController = {
    ...
    getRevenueByMonth: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    getPopularSubjects: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    getTopTutors: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    getTopStudents: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const { limit, sortBy } = req.query;
        const limitNumber = limit ? parseInt(limit) : 10;
    ...
    getUserGrowth: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const { year, months } = req.query;
        const yearNumber = year ? parseInt(year) : new Date().getFullYear();
        const monthsArray = months
            ? months.split(',').map(m => parseInt(m))
    ...
    getOverviewStats: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    getUserDistribution: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    getUnifiedSessions: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    getSessionStats: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    getApplicationStats: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    getTransactions: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    getTransactionStats: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
