...
exports.LegalPolicyService = {
    getAllPolicies: () => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield legalPolicy_model_1.LegalPolicy.find().sort({ type: 1 }).lean();
        return result;
    }),
    getPolicyByType: (type) => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield legalPolicy_model_1.LegalPolicy.findOne({ type }).lean();
        return result;
    }),
    getActivePolicyByType: (type) => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield legalPolicy_model_1.LegalPolicy.findOne({ type, isActive: true }).lean();
        return result;
    }),
    // Create or update policy
    upsertPolicy: (type, payload, userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    updatePolicy: (type, payload, userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    deletePolicy: (type) => __awaiter(void 0, void 0, void 0, function* () {
        const policy = yield legalPolicy_model_1.LegalPolicy.findOne({ type });
        if (!policy) {
            throw new ApiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, 'Policy not found');
        }
    ...
    getAllActivePolicies: () => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield legalPolicy_model_1.LegalPolicy.find({ isActive: true }).sort({ type: 1 }).lean();
        return result;
    }),
    initializeDefaultPolicies: () => __awaiter(void 0, void 0, void 0, function* () {
