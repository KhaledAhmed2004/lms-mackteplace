...
exports.LegalPolicyController = {
    getAllPolicies: (0, catchAsync_1.default)((_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    getPolicyByType: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    getActivePolicyByType: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const { type } = req.params;
    ...
    upsertPolicy: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        const { type } = req.params;
    ...
    updatePolicy: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        const { type } = req.params;
        const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.userId;
    ...
    deletePolicy: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const { type } = req.params;
    ...
    getAllActivePolicies: (0, catchAsync_1.default)((_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    initializeDefaultPolicies: (0, catchAsync_1.default)((_req, res) => __awaiter(void 0, void 0, void 0, function* () {
