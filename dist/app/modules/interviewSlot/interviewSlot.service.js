...
exports.InterviewSlotService = {
    createInterviewSlot: (adminId, payload) => __awaiter(void 0, void 0, void 0, function* () {
        // Verify admin exists
    ...
    getAllInterviewSlots: (query, userId, userRole) => __awaiter(void 0, void 0, void 0, function* () {
        let filter = {};
    ...
    getSingleInterviewSlot: (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    bookInterviewSlot: (slotId, applicantId, applicationId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    cancelInterviewSlot: (slotId, userId, cancellationReason) => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        const slot = yield interviewSlot_model_1.InterviewSlot.findById(slotId);
        if (!slot) {
            throw new ApiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, 'Interview slot not found');
     ...
     */
    markAsCompleted: (slotId) => __awaiter(void 0, void 0, void 0, function* () {
        const slot = yield interviewSlot_model_1.InterviewSlot.findById(slotId);
        if (!slot) {
            throw new ApiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, 'Interview slot not found');
        }
     ...
     */
    rescheduleInterviewSlot: (currentSlotId, newSlotId, applicantId) => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        // Get current slot
     ...
     */
    updateInterviewSlot: (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
        const slot = yield interviewSlot_model_1.InterviewSlot.findById(id);
        if (!slot) {
            throw new ApiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, 'Interview slot not found');
        }
     ...
     */
    deleteInterviewSlot: (id) => __awaiter(void 0, void 0, void 0, function* () {
        const slot = yield interviewSlot_model_1.InterviewSlot.findById(id);
        if (!slot) {
            throw new ApiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, 'Interview slot not found');
        }
     ...
     */
    getMyBookedInterview: (applicantId) => __awaiter(void 0, void 0, void 0, function* () {
        const slot = yield interviewSlot_model_1.InterviewSlot.findOne({
            applicantId: new mongoose_1.Types.ObjectId(applicantId),
            status: {
                $in: [interviewSlot_interface_1.INTERVIEW_SLOT_STATUS.BOOKED, interviewSlot_interface_1.INTERVIEW_SLOT_STATUS.COMPLETED],
            },
        })
            .populate('adminId', 'name email')
            .populate('applicationId')
     ...
     */
    getScheduledMeetings: (query) => __awaiter(void 0, void 0, void 0, function* () {
     ...
     */
    getInterviewMeetingToken: (slotId, userId) => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        const slot = yield interviewSlot_model_1.InterviewSlot.findById(slotId);
        if (!slot) {
            throw new ApiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, 'Interview slot not found');
     ...
     */
    cleanupExpiredAvailableSlots: () => __awaiter(void 0, void 0, void 0, function* () {
