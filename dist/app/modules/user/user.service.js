...
// ============ SERVICE ============
exports.UserService = {
    createUserToDB: (payload) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const roleLabel = createUser.role === user_1.USER_ROLES.STUDENT
            ? 'Student'
            : createUser.role === user_1.USER_ROLES.TUTOR
                ? 'Tutor'
                : 'User';
    ...
    getUserProfileFromDB: (user) => __awaiter(void 0, void 0, void 0, function* () {
        const { id } = user;
        const isExistUser = yield user_model_1.User.findById(id).populate('tutorProfile.subjects', 'name');
        if (!isExistUser) {
            throw new ApiError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, "User doesn't exist!");
        }
        return isExistUser;
    }),
    updateProfileToDB: (user, payload) => __awaiter(void 0, void 0, void 0, function* () {
        const { id } = user;
    ...
    getAllUsers: (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    updateUserStatus: (id, status) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    getUserDetailsById: (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    getAllStudents: (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    blockStudent: (id) => __awaiter(void 0, void 0, void 0, function* () {
        const user = yield user_model_1.User.findById(id);
        if (!user) {
            throw new ApiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, "User doesn't exist!");
        }
    ...
    unblockStudent: (id) => __awaiter(void 0, void 0, void 0, function* () {
        const user = yield user_model_1.User.findById(id);
        if (!user) {
            throw new ApiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, "User doesn't exist!");
        }
    ...
    adminUpdateStudentProfile: (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
        const user = yield user_model_1.User.findById(id);
        if (!user) {
            throw new ApiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, "User doesn't exist!");
        }
    ...
    getAllTutors: (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    blockTutor: (id) => __awaiter(void 0, void 0, void 0, function* () {
        const user = yield user_model_1.User.findById(id);
        if (!user) {
            throw new ApiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, "User doesn't exist!");
        }
    ...
    unblockTutor: (id) => __awaiter(void 0, void 0, void 0, function* () {
        const user = yield user_model_1.User.findById(id);
        if (!user) {
            throw new ApiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, "User doesn't exist!");
        }
    ...
    updateTutorSubjects: (id, subjects) => __awaiter(void 0, void 0, void 0, function* () {
        const user = yield user_model_1.User.findById(id);
        if (!user) {
            throw new ApiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, "User doesn't exist!");
        }
    ...
    adminUpdateTutorProfile: (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
        const user = yield user_model_1.User.findById(id);
        if (!user) {
            throw new ApiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, "User doesn't exist!");
        }
     ...
     */
    getTutorStatistics: (tutorId) => __awaiter(void 0, void 0, void 0, function* () {
        // Verify tutor exists
     ...
     */
    updateTutorLevelAfterSession: (tutorId) => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        const tutor = yield user_model_1.User.findById(tutorId);
        if (!tutor || tutor.role !== user_1.USER_ROLES.TUTOR) {
            return;
