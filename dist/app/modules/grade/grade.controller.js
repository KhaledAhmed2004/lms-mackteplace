...
exports.GradeController = {
    createGrade: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    getAllGrades: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    getSingleGrade: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    updateGrade: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const { gradeId } = req.params;
    ...
    deleteGrade: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const { gradeId } = req.params;
    ...
    getActiveGrades: (0, catchAsync_1.default)((_req, res) => __awaiter(void 0, void 0, void 0, function* () {
