...
exports.GradeService = {
    createGrade: (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    getAllGrades: (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    getSingleGrade: (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    updateGrade: (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    deleteGrade: (id) => __awaiter(void 0, void 0, void 0, function* () {
        const grade = yield grade_model_1.Grade.findById(id);
        if (!grade) {
            throw new ApiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, 'Grade not found');
        }
    ...
    getActiveGrades: () => __awaiter(void 0, void 0, void 0, function* () {
