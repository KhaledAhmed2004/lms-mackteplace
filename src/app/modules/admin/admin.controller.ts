...
export const AdminController = {
  ...
  getPopularSubjects: catchAsync(async (req: Request, res: Response) => {
  ...
  getTopTutors: catchAsync(async (req: Request, res: Response) => {
  ...
  getTopStudents: catchAsync(async (req: Request, res: Response) => {
    const { limit, sortBy } = req.query;
    const limitNumber = limit ? parseInt(limit as string) : 10;
  ...
  getMonthlyRevenue: catchAsync(async (req: Request, res: Response) => {
    const { year, months, tutorId, studentId, subscriptionTier, subject } =
      req.query;
  ...
  getUnifiedSessions: catchAsync(async (req: Request, res: Response) => {
    const {
      page,
      limit,
      status,
  ...
  getSessionStats: catchAsync(async (req: Request, res: Response) => {
