...
export const SupportTicketService = {
  ...
  getMyTickets: async (userId: string, query: Record<string, unknown>) => {
  ...
  getAllTickets: async (query: Record<string, unknown>) => {
    const ticketQuery = new QueryBuilder(
      SupportTicket.find().populate('user', 'name email profilePicture'),
      query,
    )
  ...
  getTicketById: async (ticketId: string): Promise<ISupportTicket | null> => {
