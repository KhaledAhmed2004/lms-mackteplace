...
export const LegalPolicyController = {
  getAllPolicies: catchAsync(async (_req: Request, res: Response) => {
  ...
  getPolicyByType: catchAsync(async (req: Request, res: Response) => {
  ...
  getActivePolicyByType: catchAsync(async (req: Request, res: Response) => {
    const { type } = req.params;
  ...
  upsertPolicy: catchAsync(async (req: Request, res: Response) => {
    const { type } = req.params;
  ...
  deletePolicy: catchAsync(async (req: Request, res: Response) => {
    const { type } = req.params;
  ...
  getAllActivePolicies: catchAsync(async (_req: Request, res: Response) => {
  ...
  initializeDefaultPolicies: catchAsync(async (_req: Request, res: Response) => {
